  ...
  render() {
      ...
      <View style={styles.container}>
        ...
        <FlatList
          ...
          renderItem={({item, index}) =>
            <View style={{ justifyContent:'center', alignItems: 'center', marginHorizontal: 15, marginVertical: 5}}>
              <TouchableOpacity
                onPress={ () => { selectionItem(index)}}
    ...
    const styles = StyleSheet.create({
        ...
        cardButton: {
            alignItems: 'center',
            justifyContent: 'flex-end',
            // backgroundColor: this.state.itemSelected ? 'red' : 'white',
